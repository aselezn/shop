...
public class Repository {
    ...
    public static List<Product> findAllProducts(Connection con) throws SQLException {
        ...
        String query = "SELECT id, product_name, color, price, balance FROM shop_db.products";
    ...
    public static void registerOrder(Connection con, String customerFullName, String phone, String email,
        ...
        order.setCreateDate(java.sql.Date.valueOf(date)); // Устанавливаем текущую дату
        ...
        String insertOrderQuery = "INSERT INTO shop_db.orders (create_date, customer_fullname, phone, email, " +
        ...
        try (Connection connection = con;
            ...
            String insertOrderItemQuery = "INSERT INTO shop_db.orders_items (order_id, product_id, order_price, quantity) " +
                    "VALUES (?, ?, ?, ?)";
